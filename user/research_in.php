...
<main role="main" class="container">   
    ...
    <div class="my-3 p-3 bg-white rounded box-shadow">
        <div class="row">
            ...
            <div class="col-md-12">
				<div class="my-3 p-3 bg-white rounded box-shadow">
					<form method="GET" action="research_out.php">
						<input type="hidden" name="token" value="<?php echo $_SESSION['token']; ?>">
						<input type="hidden" name="i" value="0">
						<!-- Research by -->
				        <h6 class="border-bottom border-gray pb-2 mb-0">Research by:</h6>
						...
						<!-- submit -->
				        <button name="browsing" value="research" type="submit" class="btn btn-primary">Submit</button>
			        </form>
			    </div>
